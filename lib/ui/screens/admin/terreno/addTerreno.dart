...
class AddTerreno extends StatefulWidget {
  _AddTerrenoState createState() => _AddTerrenoState();
}

class _AddTerrenoState extends State<AddTerreno> {
             ...
             //caja de texto del precio
              ...
              Container(
                ...
                onPressed: () async {
                  ...
                  print('URL Is $urlImg');
                  //Se agregar a la bd
                  await terrenoProvider.addTerreno(Terreno(
